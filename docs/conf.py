...
with open(os.path.join(root, 'src', 'TwitchDig', '__init__.py'), 'r') as f:
...
htmlhelp_basename = 'TwitchDigdoc'
...
latex_documents = [
    (master_doc, 'TwitchDig.tex', 'TwitchDig Documentation',
     author, 'manual'),
]
...
man_pages = [
    (master_doc, 'TwitchDig', 'TwitchDig Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'TwitchDig', 'TwitchDig Documentation',
     author, 'TwitchDig', 'One line description of project.',
     'Miscellaneous'),
]
